...
var plugin = {
    alert: function() {
        window.plugins.messageBox.alert('Title', 'Message', function(button) {
            console.log("messageBox.alert:" + JSON.stringify(arguments));
        });
    },
    confirm: function() {
        window.plugins.messageBox.confirm('Title', 'Message', function(button) {
            console.log("messageBox.confirm:" + JSON.stringify(arguments));
        });
    },
    prompt : function() {
        window.plugins.messageBox.prompt('Title', 'Message', function(button, value) {
            console.log("messageBox.prompt:" + JSON.stringify(arguments));   
        });
    },
